...
export default function EditProduct({ prodId }) {
  ...
  return (
    <div>
      <Edit onClick={handleClickOpen}>Redaguoti</Edit>
          ...
          <StyledEditProduct>
            <StyledForm onSubmit={handleSubmit}>
              ...
              <input
                ...
                required
              />
              <input type='text' placeholder='Pavadinimas' onChange={(e) => setName(e.target.value)} value={name} />
              <input
                type='text'
                placeholder='Kaina'
              ...
              <input
                ...
                required
              />
              <PrimaryButton type='submit'>{editStatus === 'pending' ? 'Redaguojama' : 'Redaguoti'}</PrimaryButton>
            </StyledForm>
            <ImagePreview>
              {previewImg ? (
                <>
                  <img src={previewImg} alt='prekės paveikslėlis' />
                </>
              ) : (
